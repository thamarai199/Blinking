...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Chinthan/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Chinthan' => 'chinthanm@gmail.com' }
  s.source           = { :git => 'https://github.com/Chinthan/BlinkingLabel.git', :tag => s.version.to_s }
